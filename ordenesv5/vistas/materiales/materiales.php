        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id="nuevoMaterialForm">
                        <input type="text" hidden id="idmaterial">
                        <div class="form-group">
                        ...
                        <label for="familiau">Familia del Material</label>
                            <select name="familia" id="familiau" class="form-control">
                                <option value="">Seleccione Familia</option>
                                <option value="cuarzo">Cuarzo</option>
                                <option value="granito">Granito</option>
                                <option value="marmol">Marmol</option>
                        ...
                        <button type="button" class="btn btn-info" id="editarMaterial">Editar Material</button>
...
<script>
    $(document).ready(function() {
        $('#tabla').load('vistas/materiales/tablamateriales.php')
